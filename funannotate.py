...
def main(input_args,filenames):
    ...
    if lib.file_exists(filenames.funannotate_clean_fasta,"Assembly already cleaned by Funannotate! Skipping...","Cleaning assembly with Funannotate clean") is False:
        funannotate_clean(input_args,filenames)
    if lib.file_exists(filenames.funannotate_sort_fasta,"Assembly already sorted by Funannotate! Skipping...","Sorting assembly with Funannotate sort") is False:
        funannotate_sort(input_args,filenames)
    if lib.file_exists(filenames.funannotate_mask_fasta,"Assembly already masked by Funannotate! Skipping...","Masking repetitive regions with Funannotate mask") is False:
        funannotate_mask(input_args,filenames)
    if lib.file_exists(filenames.funannotate_gbk,"Assembly genes already predicted with Funannotate! Skipping...","Predicting genes with Funannotate predict") is False:
